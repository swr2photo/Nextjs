...
const themeBackgrounds: Record<keyof typeof colorThemes, string> = {
  emerald: 'linear-gradient(135deg, #022c22 0%, #0f4c3a 40%, #051919 70%, #020617 100%)',
  purple: 'linear-gradient(135deg, #1e1030 0%, #4c1d95 40%, #2e1065 70%, #020617 100%)',
  blue: 'linear-gradient(135deg, #0b1220 0%, #0f172a 40%, #051a34 70%, #020617 100%)',
  rose: 'linear-gradient(135deg, #3b0820 0%, #9f1239 40%, #5b1a2f 70%, #020617 100%)',
  orange: 'linear-gradient(135deg, #3b1803 0%, #9a3412 40%, #6b2810 70%, #020617 100%)',
  cyan: 'linear-gradient(135deg, #022c3a 0%, #0e7490 40%, #064e5a 70%, #020617 100%)',
};
...
export default function MemoryGallery({
  ...
  const themeKey = themeKeyProp ?? currentTheme ?? 'emerald';
  ...
  const storySnippet = currentMemory?.text?.length > 160
          ...
          >
            ...
            >
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, flex: 1 }}>
                ...
                >
                  <AutoAwesomeIcon sx={{ fontSize: { xs: 18, md: 22 }, color: '#fff' }} />
                </Box>
                <Box sx={{ minWidth: 0 }}>
                  <Typography
                    component="h2"
                  ...
                  >
                    เส้นเรื่องของเรา {currentMemory?.accentEmoji ?? '💫'}
                  </Typography>
                  <Typography
                    sx={{
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <StarRoundedIcon sx={{ fontSize: { xs: 14, md: 16 }, color: primaryAccent, flexShrink: 0 }} />
                    {isPlaying ? 'โมเมนต์กำลังเล่นอยู่ ✨' : 'กดลูกศรเพื่อดูโมเมนต์ 💬'}
                  </Typography>
                </Box>
              </Box>
            </motion.div>
